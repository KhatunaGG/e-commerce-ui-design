...
//   getAllProducts: async () => {
//     const state = get();
//     const { take, filters, createCacheKey, sortBy, mapSortValueToBackend } =
//       state;
//     const backendSortValue = mapSortValueToBackend(sortBy);

//     const baseCacheKey = createCacheKey(
//       1,
//       filters.category,
//       filters.priceRange,
//       backendSortValue
...
//         isLoading: false,
//         axiosError: null,
//         productsDataLength: cachedDataLength,
//         pageNumber: currentPage,
//       });
//       return;
//     } else {
...
//     console.log(
//       get().cachedImagesByPage,
//       "cachedImagesByPage from LOAD MORE PRODUCTS"
//     );
