...
//  const isDisabled = !hasMoreProducts() || isLoadingMore || productsData.length === 0;
...
//       ${
//         isLoadingMore || isLoading || isDisabled ? "opacity-50 cursor-not-allowed" : "hover:opacity-90"
//       }
...
//     ? (!wishlistData || wishlistData.length === 0 || wishlistData.length >= wishlistDataLength)
//     : (!hasMoreProducts() || isLoadingMore || productsData.length === 0);
...
//       if (productsData.length === 0) return "No products";
