import { UserProps } from "@/app/interfaces/interface";

function User({ blogId, style, mobileMenu }: UserProps) {
  return (
    <svg
      width="24"
      height="24"
      ...
      className={`${blogId || mobileMenu ? "flex" : "hidden md:flex"} `}
    >
      <path
