...
//           {/* <h2
//             className={` font-semibold text-[20px] leading-8 text-[#121212] hidden md:flex  bg-red-400`}
//           >
//             {currentCategory}
//           </h2> */}
...
//           {/* <div className="lg:flex lg:justify-end items-center gap-1 hidden bg-violet-400"> */}
//           <div className="lg:flex lg:justify-start items-start gap-1 hidden bg-violet-400 max-w-[150px]">
//             <SortBy />
//           </div>
//           <SortByIcons
//             sortIcons={sortIcons}
