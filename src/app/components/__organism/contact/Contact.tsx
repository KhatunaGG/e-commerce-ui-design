...
function Contact({ register, errors }: ContactPropsType) {
  // const { normalizeFirstChar } = useShopStore();
  ...
  return (
    <div className="...">
      ...
      <Input register={register} errors={errors} fieldName="phoneNumber" />
      <Input register={register} errors={errors} fieldName="yourEmail" />
    </div>
  );
}
